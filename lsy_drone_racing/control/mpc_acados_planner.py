...
class MPC_ACADOS_PLANNER(MPC_BASE):
    ...
    def __init__(  # noqa: D417
        ...
        Args:
            ...
            visualize: enables or disables visualization of planner. Only possible when separate_thread is False
            separate_thread: make the planner run on a different thread, so that the controller can run at 60Hz
        """
    ...
    def initZoro(self, ocp: AcadosOcp):  # noqa: ANN201, D102
        if self.useZoro:
